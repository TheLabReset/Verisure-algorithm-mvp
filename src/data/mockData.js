...
export const OPPORTUNITY_SCORE = {
  ...
  components: {
    ...
    conversion_efficiency: {
      ...
      weight: 0.20,
      contribution: 14.2,
      insight: 'CPL actual $10,34 dentro del rango target ($9-12), con margen para escalar',
    },
  },
  recommendation: {
    message: 'Se observa una ventana óptima para ampliar inversión en Meta Ads orientada a la audiencia adulta planificadora durante Cyber Wow. La keyword "cuotas sin intereses" muestra intención sostenida y los comercios de tecnología y electrohogar concentran el mayor ticket promedio.',
    confidence: '88%',
    priority: 'high',
    actions: [
      'Reforzar Meta Ads con creatividades enfocadas en "no consume tu línea de crédito"',
      'Activar campaña Search en torno a Cyber Wow con landing por categoría',
      'Lanzar piezas educativas comparando Powerpay frente a la cuota tradicional con tarjeta',
      'Priorizar comercios de tecnología y electrohogar en pauta y co-branding',
    ],
  },
};
...
export const CRM_MOCKUP = {
  ...
  alerts: [
    {
      type: 'success',
      message: 'Campaña "Cyber Wow Tecnología" superando objetivos: CPL $8,33 frente al target $10',
...
export const COMPETITOR_INSIGHTS = [
  {
    ...
    description: 'BNPL bancario que aprovecha la base de clientes BCP y no requiere tarjeta de crédito',
    opportunity: 'Comunicar que Powerpay funciona con cualquier tarjeta, no solo con clientes de un banco específico',
  },
  {
    brand: 'Yape',
    full_name: 'Yape (BCP / Credicorp)',
    ...
    description: 'Billetera líder con BNPL embebido, fuerte awareness y catálogo concentrado en su marketplace',
    opportunity: 'Posicionar Powerpay para tickets medios-altos donde la billetera no es el touchpoint natural',
  },
  {
    brand: 'Divídelo',
    full_name: 'Divídelo (Interbank / Niubiz)',
    ...
    description: 'Cuotas tradicionales con tarjeta Interbank, integradas en marketplaces grandes',
    opportunity: 'Resaltar que Powerpay no consume la línea de crédito, mientras Divídelo sí lo hace',
  },
  {
    brand: 'CMR Cuotas',
    full_name: 'Banco Falabella / CMR',
    ...
    description: 'Cuotas con tarjeta CMR ancladas al ecosistema retail Falabella',
    opportunity: 'Captar usuarios fuera del ecosistema Falabella con propuesta abierta a cualquier comercio',
  },
  {
    brand: 'aCuotaz',
    full_name: 'aCuotaz (Apurata)',
    ...
    description: 'Fintech regulada por SBS enfocada en segmento sin historial crediticio',
    opportunity: 'Powerpay puede atender al usuario bancarizado que valora cualquier tarjeta y red de comercios consolidada',
  },
  {
    brand: 'Powerpay',
    full_name: 'Powerpay (BBVA / Breca)',
    ...
    description: 'BNPL puro respaldado por BBVA y Breca, con identidad propia y comercios diversos',
    opportunity: 'Acelerar awareness y consolidar el mensaje de "el poder de elegir cómo pagar"',
  },
];
